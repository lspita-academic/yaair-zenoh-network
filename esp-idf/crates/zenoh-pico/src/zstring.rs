...
use zenoh_pico_core::{
    ...
    sys::{z_string_copy_from_str, z_string_empty, z_view_string_empty},
};
use zenoh_pico_macros::{zown, zview};
...
impl FromStr for ZString {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        unsafe {
            z_string_copy_from_str(&mut zstring, value.as_ptr()).into_zresult()?;
        }
